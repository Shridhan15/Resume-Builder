import { FilePenLineIcon, Plus, PlusIcon, UploadCloudIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 sm:flex flex-wrap gap-4">
          ...
          {allResumes.map((resume,index)=>{
            ...
            return (
              <button key={index} className="relative w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer" style={{background:`linear-gradient(135%, ${basecolor}10, ${basecolor}40)`, borderColor:basecolor+40}}>
